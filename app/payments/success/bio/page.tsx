...
function BioSuccessContent() {
  ...
  const [orderDetails, setOrderDetails] = useState({
    productName: 'Professional Bio',
    price: '$29',
    deliveryTime: '48 hours',
    nextProduct: 'Content Kit',
    nextProductPrice: '$299',
    nextProductLink: '/products/content-kit'
  })
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="text-center mb-8">
                ...
                <h1 className="text-3xl md:text-4xl font-bold text-primary">Payment Successful!</h1>
                <p className="text-light text-lg mt-2">Thank you for your purchase</p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>We'll craft your professional bio based on your workshop interview.</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-accent mt-1 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>You'll receive an email with your bio within {orderDetails.deliveryTime}.</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-5 h-5 text-accent mt-1 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>If you need any revisions, simply reply to the delivery email.</span>
                  </li>
                </ul>
              </div>
              
              <div className="bg-surface-light rounded-custom p-6">
                <h3 className="text-lg font-semibold text-primary mb-3">Ready to elevate your brand further?</h3>
                <p className="mb-4">Take your professional presence to the next level with our Content Kit, which includes a full "About" page, social media posts, and quote graphics.</p>
                <div className="text-center">
                  ...
                  >
                    Explore the Content Kit ({orderDetails.nextProductPrice})
                  </Link>
                </div>
              </div>
            </>
